 ...
 */
public class DrawerListAdapter extends RecyclerView.Adapter<DrawerListAdapter.DrawerView>
  ...
  public DrawerListAdapter(Activity activity, OnStartDragListner onStartDragListner,
  ...
  public DrawerView onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    if (viewType == 0) {
      ...
      View itemView = LayoutInflater.from(parent.getContext())
          .inflate(R.layout.add_platform_cell, parent, false);
      viewHolder = new AddPlatformCell(itemView);
    } else if (viewType == 2) {
      View itemView = LayoutInflater.from(parent.getContext())
          .inflate(R.layout.save_platform_cell, parent, false);
      viewHolder = new SavePlatformCell(itemView);
    } else {
      View itemView = LayoutInflater.from(parent.getContext())
          .inflate(R.layout.edit_platform_cell, parent, false);
  ...
  public class DrawerView extends RecyclerView.ViewHolder {
    ...
    public void update() {
      ...
      imageView.setImageDrawable(
          activity.getResources().getDrawable(list.get(position).getIconID()));
  ...
  public class SavePlatformCell extends DrawerView {
    ...
    public void update() {
      ...
      saveButton.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          new AnalyticsTracker(activity).sendEvent("Drawer", "Update platform list",
              platformTextView.getText().toString());
          if (getAdapterPosition() + 1 == getItemCount()) {
            ...
            realmManager.updatePlatform(list.get(getAdapterPosition() - 1),
                platformTextView.getText().toString());
          }
          setupDrawerList();
          resetView();

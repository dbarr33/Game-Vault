...
public class DragNDropListView extends ListView {
    ...
    public void setmDrawerOffset(int mDrawerOffset) {
        this.mDrawerOffset = mDrawerOffset;
    }
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		if (action == MotionEvent.ACTION_DOWN && x > this.getWidth() - this.getWidth()/6) {
			mDragMode = true;
		}
	...
	private void drag(int x, int y) {
		if (mDragView != null) {
            ...
            layoutParams.x = (int) (- height/getResources().getDisplayMetrics().scaledDensity);
            */
            DisplayMetrics metrics = getContext().getResources().getDisplayMetrics();
            float dp = 60f;
            float fpixels = metrics.density * dp;
            layoutParams.x = -(int) (fpixels + 0.5f);
